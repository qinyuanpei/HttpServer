...
RUN export sonar-scanner="./sonarscanner/bin/sonar-scanner"
...
RUN sudo sonar-scanner -D sonar.host.url="https://sonarcloud.io" /d:sonar.login="db795a28468dc7c12805b330afed53d362fdd2d9"
